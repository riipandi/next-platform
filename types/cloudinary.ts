...
declare global {
  var cloudinary: {
    applyUploadWidget: (element: unknown, options: CloudinaryWidgetOptions, widgetCallback?: Function) => void
    createUploadWidget: (options: CloudinaryWidgetOptions, widgetCallback?: Function) => CloudinaryWidget
